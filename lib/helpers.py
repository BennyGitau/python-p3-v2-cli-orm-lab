...
def create_employee():
    ...
    department_id = input("Enter employee's department: ")
...
def update_employee():
    ...
    if employee := Employee.find_by_id(id_):
        try:
            ...
            employee._job_title = title
            department = input("Enter employee department: ")
            employee._department_id = department
...
def delete_employee():
    ...
    if employee := Employee.find_by_id(id_):
        employee.delete()
        print(f"Empoyee {id_} deleted")
    else:
        print(f"Employee was not found")
...
def list_department_employees():
    ...
    if department :=Department.find_by_id(id):
        ...
        print(f"Department {id} does not exist")